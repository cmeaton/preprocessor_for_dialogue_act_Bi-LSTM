...
'''See hyperparameter values below. First group are out of the box from the repo. 
The second group are the values chosen in the paper. '''

# # original hyperparamter list from repo
...
# hyperparamter list from paper
hidden_size_lstm_1 = 300
...
class DAModel():
    def __init__(self):
        ...
        with tf.variable_scope("embeddings"):
            ...
            self.word_embeddings = tf.nn.dropout(word_embeddings, drop)
        ...
        with tf.variable_scope("bi-lstm"):
            ...
            outputs = tf.nn.dropout(outputs, drop)
